...
#define DHT11_DEBUG                STD_OFF
#define Nitrogen_DEBUG             STD_OFF
#define Phosphorus_DEBUG           STD_OFF
#define Potassium_DEBUG            STD_OFF
#define PH_DEBUG                   STD_OFF
...
//MQTT Configuration
#define MQTT_BROKER                "10.200.170.102"
